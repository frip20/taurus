app.directive('anguPages', [function () {
    return {
        ...
        template: '<div ng-show="totalItems>0" class="paginator" id="{{id}}_paginator"><div>Total items: {{ totalItems }}</div> <div>Paginas: {{ currentPage }} of {{ totalPages }}</div> <div><input ng-click="currentPage=1" ng-disabled="totalPages<=1 || currentPage<=1" class="navbtn first" type="button" value="">  <input ng-click="currentPage=currentPage-1" ng-disabled="totalPages<=1 || currentPage<=1" type="button" class="navbtn previous" value="">  <input ng-click="currentPage=currentPage+1" ng-disabled="totalPages <= 1 || currentPage == totalPages" class="navbtn next" type="button" value="">  <input ng-disabled="totalPages <= 1 || currentPage == totalPages" type="button" class="navbtn last" value="" ng-click="currentPage=totalPages"></div><div>',
